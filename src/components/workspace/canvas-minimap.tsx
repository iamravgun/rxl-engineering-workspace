...
export function CanvasMinimap() {
  return (
    <div className="pointer-events-auto absolute bottom-5 right-5 w-[190px] overflow-hidden rounded-md border border-rxl-border bg-rxl-panel/95 shadow-lg shadow-black/20 backdrop-blur-sm">
